In this file, we provide the synthetic network data that we work on in the Section 4 simulation studies of the "A Zero-Inflated Poisson Latent Position Cluster Model" (ZIP-LPCM) paper.
